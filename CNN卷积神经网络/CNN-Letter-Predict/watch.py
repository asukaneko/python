...
import os,gzip,mnist
def mnist_parse_file(fname):
    fopen = gzip.open if os.path.splitext(fname)[1] == '.gz' else open
    with fopen(fname, 'rb') as fd:
        return mnist.parse_idx(fd)

data = mnist_parse_file("emnist-letters-train-images-idx3-ubyte.gz")[30000:35000]
result = mnist_parse_file("emnist-letters-train-labels-idx1-ubyte.gz")[30000:35000]
test_images = mnist_parse_file("emnist-letters-test-images-idx3-ubyte.gz")[3000:6000]
test_labels = mnist_parse_file("emnist-letters-test-labels-idx1-ubyte.gz")[3000:6000]
print(result)
win=tk.Tk()
